...
void inputLinkTerms(linkedPolynomialTerm *&polyPtr, int coef, int expo)
{
	...
	//if:poly���S�F��(�|����J)or"�s���Ȫ�����"��"�Y������"�j
	if(polyPtr == nullptr || tmpPtr->expo > polyPtr->expo) //���b"�Y"���e�� 
	{
		tmpPtr->nextTermPtr = polyPtr;
		polyPtr = tmpPtr;
	}
	else if(tmpPtr->expo == polyPtr->expo) //else if:"�s���Ȫ�����"����"�Y������"�A�N��������
	{
	...
	else 
	{
		...
		linkedPolynomialTerm *current = polyPtr;
		while(current->coef != 0 && tmpPtr->expo < current->expo) //�p�G"�{�b��m����"��"��J������"�j���ܡA�N�~�򩹫��
		{//���ؼ�:5 3 1  [2]
			prev = current;
			current = current->nextTermPtr;
		}//�n�O1.�{�b��m���s�b or 2.���ؼ� �~�|��
		if(current->coef == 0)//����ڤF �N�������b�᭱
			prev->nextTermPtr = tmpPtr;
		else if(current->expo == tmpPtr->expo) //��̹����ۦP���ܡA������
		{
