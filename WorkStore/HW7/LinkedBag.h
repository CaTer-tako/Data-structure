...
{
   if(headPtr == nullptr)//待除錯
   {
      add(newEntry);
      return true;
   }
   Node<ItemType>* preNodePtr = new Node<ItemType>();
   Node<ItemType>* newNodePtr = new Node<ItemType>();
   Node<ItemType>* curNodePtr = new Node<ItemType>(); 
   curNodePtr = headPtr;
   preNodePtr = nullptr;
   while(curNodePtr->getNext() != nullptr)
   {
   ...
   newNodePtr->setItem(newEntry);
   newNodePtr->setNext(curNodePtr);
   if(preNodePtr == nullptr)
      headPtr = newNodePtr;
   else preNodePtr->setNext(newNodePtr);
   itemCount++;
...
bool LinkedBag<ItemType>::removeLast()
{
   ...
   if(!canRemoveItem)return canRemoveItem;
   Node<ItemType>* nextNodePtr = new Node<ItemType>();
   Node<ItemType>* preNodePtr = new Node<ItemType>();
   nextNodePtr = headPtr;
   while(nextNodePtr->getNext() != nullptr)
   {  
      preNodePtr = nextNodePtr;
      nextNodePtr = nextNodePtr->getNext();
   }
   preNodePtr->setNext(nullptr); 
   nextNodePtr = nullptr;
   itemCount--;
...
bool LinkedBag<ItemType>::remove2ndToLast()
{
   ...
   nextNodePtr = headPtr;
   preNodePtr = nullptr;
   while(nextNodePtr->getNext()->getNext() != nullptr)
   {  
      preNodePtr = nextNodePtr;
      nextNodePtr = nextNodePtr->getNext();
   }
   ...
   if(preNodePtr == nullptr)
      headPtr = nextNodePtr->getNext();
   else 
      preNodePtr->setNext(nextNodePtr->getNext()); 
